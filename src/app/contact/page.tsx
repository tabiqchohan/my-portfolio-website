      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        <ScrollReveal delay={0.2}>
          <div className="space-y-6">
              <div className="rounded-2xl border border-stone-200 dark:border-stone-700/50 bg-white dark:bg-stone-900/80 p-6 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm text-stone-600 dark:text-stone-400">{siteConfig.address}</span>
              </div>
