    ...
    <section className="relative min-h-[calc(100vh-4rem)] flex items-center">
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <h1 className="mt-6 text-4xl sm:text-5xl lg:text-6xl font-bold text-zinc-900 dark:text-white leading-tight">
            Hi, I&apos;m{" "}
          ...
          <p className="mt-3 text-2xl sm:text-3xl font-semibold text-zinc-700 dark:text-zinc-300">
            <TypingAnimation />
          </p>

          <p className="mt-4 text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-xl">
